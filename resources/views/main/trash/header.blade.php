...
<!-- Mirrored from thewebmax.com/spa/index-5.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 06 Jun 2019 18:47:36 GMT -->
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="images/hadakareeicon.png" />
    
    <!-- PAGE TITLE HERE -->
    <title>Hadakaree | Home Page</title>
    ...
    <link rel="stylesheet" class="skin" type="text/css" href="main/css/skin/skin-7.css">
    <!-- CUSTOM  STYLE SHEET -->
                ...
                <div class="main-bar bg-white">
                    <div class="container">
                        <div class="logo-header">
                            <a href="index.html">
                               <!-- <img src="images/hadakareeicon.png" width="216" height="37" alt="" />-->
                            </a>
                        </div>
                        <!-- NAV Toggle Button -->
                        ...
                        <div class="header-nav navbar-collapse collapse ">
                            <ul class=" nav navbar-nav">
                                <li >
                                    <a href="#">Home<i aria-hidden="true"></i></a>
                                  
                                </li>
                            
                                <li>
                                    <a href="#">Treanding<i ></i></a>
                                    <!--<ul class="sub-menu">
                                        <li>
                                ...
                                <li>
                                    <a href="{{url('login')}}">Login<i ></i></a>
                                    
                                </li>
                                
                                <li>
                                    <a href="{{url('register')}}">Register<i ></i></a>
