                              ...
                              <div class="about4-content">
                                    ...
                                    <div>
                                        ...
                                        <form class="radius-sm" action="make_appoinment">
                                                    ...
                                                    <button class="site-button font-weight-700 inline-block text-uppercase p-lr15" value="{{$user->id}}" name="salon" type="submit">Book now1>><i class="fa fa-angle-double-right"></i></button>
